...
const Under = () => {
    return (
        <div className='text-center  text-black my-8'>
            ...
            <div className='my-8 h1'>
                <h1 className='text-xl my-2'>How does rreact work?</h1>
                <div className='text-left px-8 text-justify table-color'>
            ...
            <div>
                ...
                <div className='text-left px-8 text-justify'>
                    <div className="overflow-x-auto text-left ">
                        <table className=" w-full table-color">
